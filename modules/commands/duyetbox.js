...
module.exports.run = async ({ api, event, handleReply, Threads, args, Users }) => {
  ...
  //if (senderID != `616652161` && senderID != `616652161` && senderID != `616652161` && senderID != `616652161` && senderID != `616652161` && senderID != `616652161` && senderID != `616652161`) return
 // if (this.config.credits != "DungUwU mod by Duy mod full reply + gọn by TrúcCute") return api.sendMessage(`Phát hiện thay credits`, threadID)
