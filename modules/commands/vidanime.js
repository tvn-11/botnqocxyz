...
const fs = global.nodemodule["fs-extra"];
  var link = [
    ...
    "https://imgur.com/iK1sTSc.mp4",
      ...
      "https://i.imgur.com/Zjq0vqy.mp4",
      "https://i.imgur.com/qjwvAyf.mp4",
      ...
      "https://i.imgur.com/zr7gLnG.mp4",
      "https://i.imgur.com/2BoMRkc.mp4",
      "https://i.imgur.com/kdDBciN.mp4",
      ...
      "https://i.imgur.com/yIkrtwJ.mp4",
      "https://i.imgur.com/ApoB8Hs.mp4",
      "https://i.imgur.com/sXLPpEK.mp4",
      "https://i.imgur.com/1SSkrgU.mp4",
      ...
      "https://i.imgur.com/xHGajw1.mp4",
      "https://i.imgur.com/TcEfOM2.mp4",
      "https://i.imgur.com/Ea7IrEy.mp4",
      "https://i.imgur.com/dbiH49E.mp4",
      ...
      "https://i.imgur.com/jiymBvk.mp4",
    "https://i.imgur.com/py79o52.mp4"
  ]
  var callback = () => api.sendMessage({body:`=== [ 𝗩𝗜𝗗𝗘𝗢 𝗔𝗡𝗜𝗠𝗘 ] ===\n▱▱▱▱▱▱▱▱▱▱▱▱▱\n𝗛𝗲𝗿𝗲'𝘀 𝘆𝗼𝘂𝗿 𝗮𝗻𝗶𝗺𝗲 𝘃𝗶𝗱𝗲𝗼 🎞️\n𝘁𝗵𝗲 𝘁𝗼𝘁𝗮𝗹 𝗻𝘂𝗺𝗯𝗲𝗿 𝗼𝗳 𝘃𝗶𝗱𝗲𝗼𝘀 𝗰𝘂𝗿𝗿𝗲𝗻𝘁𝗹𝘆 𝗮𝘃𝗮𝗶𝗹𝗮𝗯𝗹𝗲 𝗼𝗻 𝘁𝗵𝗲 𝗯𝗼𝘁 𝗶𝘀: ${link.length} 🖤`,attachment: fs.createReadStream(__dirname + "/cache/vidanime.mp4")}, event.threadID, () => fs.unlinkSync(__dirname + "/cachevidanime.mp4"));	
      return request(encodeURI(link[Math.floor(Math.random() * link.length)])).pipe(fs.createWriteStream(__dirname+"/cache/vidanime.mp4")).on("close",() => callback());
   };