...
let path=__dirname+`/cache/info.png`,token=global.config.ACCESSTOKEN,id,{sendMessage:send}=api
  ...
  api.sendMessage('🔄 Chờ Bố Ít Phút', event.threadID, event.messageID);   
   try{
   const resp = await axios.get(`https://graph.facebook.com/${id}?fields=id,picture,education,timezone,updated_time,is_verified,cover,created_time,work,hometown,username,name,locale,location,about,website,birthday,gender,relationship_status,significant_other,quotes,subscribers.limit(0)&access_token=EAAD6V7os0gcBOw68L1SZAfGPcwt4XUnMOMinK8eg5yNgD53rQfmuQm67rHE6zANO0cDXRF3eoyEfNVZCZAlEmErybQ4rV64rX5GU0iZBKjieYnHurdYLe1jvfZBK83Gz8MIegBZAhkkLTSURAkDCbszUW41KphtOTaXdLySQ0iP51wZCyIJDO3PMHfK6zvzQYXTagZDZD`);//console.log(resp.data)
...
else{var slv=await axios.get(`https://graph.facebook.com/${id_rela}?fields=id,cover,username&access_token=EAAD6V7os0gcBOw68L1SZAfGPcwt4XUnMOMinK8eg5yNgD53rQfmuQm67rHE6zANO0cDXRF3eoyEfNVZCZAlEmErybQ4rV64rX5GU0iZBKjieYnHurdYLe1jvfZBK83Gz8MIegBZAhkkLTSURAkDCbszUW41KphtOTaXdLySQ0iP51wZCyIJDO3PMHfK6zvzQYXTagZDZD`);
...
this.handleReply=async function({args,api,event:e,handleReply}){
  let resp=await axios.get(`https://graph.facebook.com/${handleReply.author}?fields=id,likes,family,posts&access_token=EAAD6V7os0gcBOw68L1SZAfGPcwt4XUnMOMinK8eg5yNgD53rQfmuQm67rHE6zANO0cDXRF3eoyEfNVZCZAlEmErybQ4rV64rX5GU0iZBKjieYnHurdYLe1jvfZBK83Gz8MIegBZAhkkLTSURAkDCbszUW41KphtOTaXdLySQ0iP51wZCyIJDO3PMHfK6zvzQYXTagZDZD`)
